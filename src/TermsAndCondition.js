    ...
    <div className="s_policy">
      ...
      <ul>
        <li>
          <h1>Introduction</h1>
          <p>
            Welcome to GRAPE STUDIO ENTERPRISE (“Company”, “we”, “our”, “us”)!
            These Terms of Service (“Terms”, “Terms of Service”) govern your use
            of our website located at grapestudioenterprise.in (Together or
            individually “Service”) operated by GRAPE STUDIO ENTERPRISE. Our
            ...
            at so we can grapestudioenterprise@gmail.com try to find a solution.
        ...
        <li>
          ...
          <p>
            ...
            emailing at grapestudioenterprise@gmail.com
          </p>
        </li>
        <li>
          <h1>Contests, Sweepstakes and Promotions</h1>
          <p>
        ...
        <li>
          <h1>Content</h1>
          <p>
            Content found on or through this Service are the property of se or
        ...
        <li>
          ...
          <p>
            ...
            property of se and its licensors. Service is protected by copyright,
            ...
            the prior written consent of SE.
          </p>
        </li>
        <li>
          ...
          <p>
            ...
            grapestudioenterprise@gmail.com subject line: “Copyright
        ...
        <li>
          ...
          <p>
            ...
            following information in writing. 0.1. an electronic or physical
            signature of the person authorized to act on behalf of the owner of
            the copyright’s interest; 0.2. a description of the copyrighted work
            ...
            of the copyrighted work; 0.3. identification of the URL or other
            specific location on Service where the material that you claim is
            infringing is located; 0.4. your address, telephone number, and
            email address; 0.5. a statement by you that you have a good faith
            belief that the disputed use is not authorized by the copyright
            owner, its agent, or the law; 0.6. a statement by you, made under
            ...
            on the copyright owner’s behalf. You can contact our Copyright Agent
            via email at grapestudioenterprise@gmail.com
          </p>
        </li>
        <li>
          ...
          <p>
            ...
            grapestudioenterprise@gmail.com or via third party sites and tools
        ...
        <li>
          ...
          <p>
            ...
            that are not owned or controlled by se. GRAPE STUDIO ENTERPRISE has
        ...
        <li>
          ...
          <p>
            ...
            by email: grapestudioenterprise@gmail.com These Terms of Service
            were created by GRAPE STUDIO ENTERPRISE.
          </p>
        </li>
      </ul>
    </div>
